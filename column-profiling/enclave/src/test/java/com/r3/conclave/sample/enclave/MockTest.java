...
public class MockTest {
    ...
    void dataAnalysis() throws EnclaveLoadException {
        ...
        assertEquals("Age Frequency Distribution: {45=2} Country Frequency Distribution: {USA=1, India=1} Gender Frequency Distribution: {f=1, m=1}", new String(daEnclave.previousResult));
    }
}
